...
export function Hero() {
  ...
  return (
    <section id="home" className="relative flex h-[100svh] min-h-[640px] w-full items-end overflow-hidden">
      ...
      <div className="absolute inset-0 bg-gradient-to-t from-nvn-black via-nvn-black/60 to-nvn-black/20" />
      <div className="absolute inset-0 bg-gradient-to-b from-nvn-black/70 via-transparent to-transparent" />
